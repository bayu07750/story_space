...
abstract class $SettingCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isDarkMode, Locale locale});
}
...
class _$SettingImpl implements _Setting {
  const _$SettingImpl({required this.isDarkMode, required this.locale});
  ...
  @override
  String toString() {
    return 'Setting(isDarkMode: $isDarkMode, locale: $locale)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isDarkMode, locale);
...
abstract class _Setting implements Setting {
  const factory _Setting(
      ...
      required final Locale locale}) = _$SettingImpl;
